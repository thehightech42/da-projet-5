...
<html lang="fr">
    <head>
        ...
        <link href="<?= $_SERVER['REQUEST_SCHEME']?>://<?= $_SERVER['SERVER_NAME']?>/css/stylebaseadmin.css" rel="stylesheet" />
        <link href="<?= $_SERVER['REQUEST_SCHEME']?>://<?= $_SERVER['SERVER_NAME']?>/css/stylesbase.css" rel="stylesheet" />
        <link href="<?= $_SERVER['REQUEST_SCHEME']?>://<?= $_SERVER['SERVER_NAME']?>/css/style.css" rel="stylesheet" />
